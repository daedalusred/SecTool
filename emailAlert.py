...
class Email:
    def __init__(self, duration, plugin_name="Wapiti", json_output_filename="wapitiOutput.json",
    ...
    def email_output_preamble(self):
        preamble = NO_REPLY
        preamble += KNOWN_SENDERS
        preamble += MARKDOWN
    ...
    def parse_wapiti_output(self, json_data):
        ...
        output = self.email_output_preamble()
